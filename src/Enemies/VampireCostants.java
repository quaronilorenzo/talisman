...
public class VampireCostants {
    ...
    List<String> KILLPHRASES = List.of(
            ...
            "Silence suits you.",
            "Fleeting, fragile, finished.",
            "The night grows darker… with you gone.",
            "Ashes remember what blood forgets.",
            "I taste victory… and inevitability.",
            "Rest now. Eternity is mine.",
